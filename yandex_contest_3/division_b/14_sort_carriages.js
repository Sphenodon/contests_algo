...
for (let carriage of carriages){
    if (carriage === rail_2[rail_2.length - 1] + 1){
        rail_2.push(carriage)
        let last_in_bay = bay[bay.length - 1]
        while (last_in_bay === rail_2[rail_2.length - 1] + 1){
            rail_2.push(bay.pop())
            last_in_bay = bay[bay.length - 1]
        }
        continue
    }
    bay.push(carriage)
